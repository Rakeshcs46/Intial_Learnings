...
# # print(my_calculator.add(2, 3, 4))   # Output: 9
...
# print(my_account.__balance)      # Output: AttributeError: 'BankAccount' object has no attribute '__balance'
# print(my_account.get_balance())  # Output: 5000

# my_account.__balance = 10000     # This doesn't actually change the balance because the attribute is private
# print(my_account.get_balance())  # Output: 5000

# my_account.deposit(2000)
# print(my_account.get_balance())  # Output: 7000

# my_account.withdraw(3000)
# print(my_account.get_balance())  # Output: 4000

# my_account.withdraw(5000)       # Output: Insufficient balance
